<?php
    ...
    if(isset($_GET['size']) && isset($_GET['offset'])){
        ...
        $query = "SELECT * FROM dependencias LEFT JOIN registros ON dependencias.iddependencia = registros.dependencias_iddependencia GROUP BY iddependencia ORDER BY iddependencia DESC;";
    }
