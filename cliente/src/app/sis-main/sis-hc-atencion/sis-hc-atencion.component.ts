...
@Component({
  selector: 'app-sis-hc-atencion',
  templateUrl: './sis-hc-atencion.component.html',
  styleUrls: ['./sis-hc-atencion.component.css']
})
export class SisHcAtencionComponent implements OnInit {
  ...
  constructor(private service: SisHcAtencionService, private toastr: ToastrService) { 
    this.solicitudes = [];
