...
export class SisHcRegistroService {
  ...
  getSolicitanteFilter(index: string, type: string){
    let params = new HttpParams();
    params = params.append('index', index);
    params = params.append('type', type);
    return this.http.get<[]>(this.URI+'solicitantes/buscar_solicitantes.php',{params: params});
  }
  getPacienteFilter(index: string, type: string){
    let params = new HttpParams();
    params = params.append('index', index);
    params = params.append('type', type);
    return this.http.get<[]>(this.URI+'pacientes/buscar_pacientes.php',{params: params});
  }
}
