...
@Component({
  selector: 'app-sis-modulos',
  templateUrl: './sis-modulos.component.html',
  styleUrls: ['./sis-modulos.component.css']
})
export class SisModulosComponent implements OnInit {
  ...
  constructor(private service: SisModulosService, private toastr: ToastrService) { 
    this.usuarios = [];
