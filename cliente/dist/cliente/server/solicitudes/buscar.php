<?php
    ...
    switch ($type) {
        case 'estado':
            $query = "EXEC pr_s_solicitud_hc_estado @id_estado_solicitud = '$key';";
            break;
        
        case 'nombre':
            $query = "SELECT TOP(30) * FROM [dbo].[solicitud_hc] WHERE nombre LIKE '%$key%' ORDER BY id_solicitud_hc DESC;";
            break;
    }
